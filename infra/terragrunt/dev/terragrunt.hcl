...
inputs = {
  resource_group_name    = "barrel-rg-eastus2"
  resource_prefix        = "barrel"
  env_suffix             = "us2"
  openai_account_name    = "barrel-openai-eastus2"
  ...
  vision_endpoint = get_env("AZURE_VISION_ENDPOINT", "https://barrel-vision-eastus2-28458.cognitiveservices.azure.com/")
